...
CREATE TABLE IF NOT EXISTS `school`(
	Code        nvarchar(30)   COMMENT '网站代码',
	Name        nvarchar(100)   COMMENT '学校名称',
	Address     nvarchar(100)   COMMENT '学校地址',
	Region      nvarchar(10)   COMMENT '区县',
	Slice  int COMMENT '第N学区',
	Tags        nvarchar(200) COMMENT '标签',
	Estate      int      COMMENT '对应小区个数',
	PriceFrom   int      COMMENT '价格最低',
	PriceTo     int      COMMENT '价格最高',
	NumberOfSet int      COMMENT '房源套数',
	UrlOfSchool nvarchar(100)   COMMENT '学校详情URL',
	UrlOfOrigin nvarchar(500)   COMMENT '房源列表URL',
   PRIMARY KEY (`Code`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `house`(
	Code nvarchar(30) COMMENT '网站代码',
	Title       nvarchar(200) COMMENT '标题',
	Region      nvarchar(10) COMMENT '区县',
	Address     nvarchar(200) COMMENT '地址',
	Estate      nvarchar(100) COMMENT '所属小区',
	Year        int   COMMENT  '建筑年份',
	FloorTotal  int    COMMENT '楼层总数',
	FloorLoc    nvarchar(10) COMMENT  '楼层位置',
	HouseDirect nvarchar(10) COMMENT '房子朝向',
	Hall        int COMMENT '厅',
	Room        int COMMENT '室',
	Area        int    COMMENT '面积',
	School      nvarchar(100) COMMENT  '学校名称',
	PriceTotal  int    COMMENT '总价',
	PriceSQM    int   COMMENT  '每平米价格',
	Tags         nvarchar(200) COMMENT    '标签',
	UrlOfHouse  nvarchar(100) COMMENT  '房子详情页URL',
	UrlOfMainImg nvarchar(200) COMMENT  '主图URL',
	Source       nvarchar(10) COMMENT    '数据来源',
	CreateAt     datatime     COMMENT    '插入时间',
   PRIMARY KEY ( `Code` )
)ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `region`(
	Code        nvarchar(30)   COMMENT 'URL代码',
	Name        nvarchar(10)   COMMENT '区名',
	NumOfSlice  int COMMENT '学区片个数',
   PRIMARY KEY (`Code`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `high`(
	Id int  NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '自增主键',
	Region        nvarchar(10)   COMMENT '区名',
	Slice  int COMMENT '第N学区',
	Name nvarchar(100)   COMMENT '中学名称',
	Tags nvarchar(500) comment '标签'
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `scope`(
	...
	Slice  int  COMMENT    '片',
	School   nvarchar(100)   COMMENT '学校名称',
	RC     nvarchar(50)   COMMENT '居委会',
	Estate nvarchar(50)   COMMENT '小区名称',
	Other  nvarchar(100)   COMMENT '道、路、胡同、楼起止号码',
	Url nvarchar(100) COMMENT 'ke.com小区房源列表'
)ENGINE=InnoDB DEFAULT CHARSET=utf8;


CREATE TABLE IF NOT EXISTS `proxy`(
	Ip nvarchar(100)  NOT NULL PRIMARY KEY COMMENT '代理IP',
	Score int   COMMENT '分值1-10，新插入的ip为10，一次访问失败-1，减为0时删除该条数据'
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
